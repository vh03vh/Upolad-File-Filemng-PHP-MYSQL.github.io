...
$(document).ready(function() {
    ...
    $('a.version-info').click(function(){
    	...
    	$('#modal').html(' ');
 		...
 		var output = '<div class="modal-content"><h5><?php echo lang::get("File Manager")?> <?php echo VERSION?></h5><hr />';
 		output += '<p>Copyright &copy; 2011-<?php echo date('Y')?> by File Manager. All right reserved.</p><p>Designed & developed by alcalbg. Logo design by batabarata.</p><p>For more info please visit gator\'s web page <a href="http://www.file-gator.com" target="_blank">www.file-gator.com</a></p>';
